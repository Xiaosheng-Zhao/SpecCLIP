...
Click the badge to open the tutorial directly in Google Colab — no local setup required. The notebook clones this repo, installs dependencies, downloads the pretrained checkpoints (~2.3 GB), and walks through similar-star retrieval and cross-modal spectrum prediction end-to-end.
